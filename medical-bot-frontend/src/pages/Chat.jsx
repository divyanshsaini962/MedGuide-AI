  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans flex flex-col">
      ...
      <main className="flex-1 flex pt-14">
        ...
        <aside className="fixed left-0 top-14 w-64 h-screen bg-white border-r border-gray-200 flex-shrink-0 hidden md:block overflow-y-auto">
          <div className="p-4">
            <div className="mb-6">
        ...
        <div className="flex-1 flex flex-col md:ml-64">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-2">MedGuide AI</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl w-full mb-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">Answers backed by medical literature and research</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">Your health conversations are confidential</p>
              </div>
            </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-4 z-10">
          <div className="max-w-4xl mx-auto md:ml-64">
            <div className="relative">
              <div className="flex items-center bg-white border-2 border-gray-200 rounded-2xl px-6 py-4 focus-within:ring-4 focus-within:ring-blue-100 focus-within:border-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl">
                <button 
                  disabled={isLoading}
